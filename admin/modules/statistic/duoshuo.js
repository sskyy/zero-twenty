angular.module('statistic.duoshuo.hottest',['preload']).controller('statistic.duoshuo.hottest',function($scope, $http,$attrs,preload){
...
angular.module('statistic.duoshuo.newest',['preload']).controller('comments.duoshuo.newest',function($scope, $http,$attrs,preload){
